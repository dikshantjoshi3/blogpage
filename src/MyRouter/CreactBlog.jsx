...
function CreactBlog({ data, setData }) {
  ...
  return (
    <>
      ...
      <form
        onSubmit={storeData}
        className="box-content mx-9 border border-black p-4"
      >
        ...
        />
        {err && (
          <span className="text-red-500">Minimum 10 letters required!</span>
        )}
        <br />
        <br />
        ...
        />
        {err && (
          <span className="text-red-500">Minimum 50 letters required!</span>
        )}
        <br />
        <br />
        ...
        <button
          type="submit"
          //   onClick={setData}
          className="bg-black text-yellow-600 p-2 mt-4"
        >
          Submit
        </button>
        <button
          type="submit"
          //   onClick={setData}
          className="mx-2 bg-black text-yellow-600 p-2 mt-4"
        >
          Review Data
        </button>
      </form>
